package com.example.myfirstapplicationinclass;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void calcularMedia(View view){
        try {
            ...
            //                                                                   | pra não dar erro |
            if (Float.parseFloat(txtMedia.getText().toString()) < 6 || txtFaltas.getText().toString().isEmpty() || Integer.parseInt(txtFaltas.getText().toString()) > 20) {
